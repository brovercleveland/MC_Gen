...
#process.RandomNumberGeneratorService.generator.initialSeed = 8675309+NTRIALS*NJOB
...
process.source = cms.Source("PoolSource",
    ...
    #fileNames = cms.untracked.vstring('file:testOut0/PYTHIA8_175_POWHEG_H_Zg_8TeV_cff_py_GEN_SIM_20.root')
)
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    #fileName = cms.untracked.string('PYTHIA8_175_POWHEG_H_Zg_8TeV_cff_py_GEN_SIM_REDIGI_DIGI_L1_DIGI2RAW_HLT_PU_20.root'),
    fileName = cms.untracked.string('PYTHIA8_175_POWHEG_H_Zg_8TeV_cff_py_GEN_SIM_REDIGI_DIGI_L1_DIGI2RAW_HLT_PU_NJOB.root'),
