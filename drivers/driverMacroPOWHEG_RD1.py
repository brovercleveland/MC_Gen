...
if int(step) == 0:
  os.system('cmsDriver.py PYTHIA8_POWHEG_RD1_H_Zg_8TeV_cff.py \
      --step GEN,SIM \
  ...
  os.system('cmsDriver.py REDIGI_PYTHIA8_POWHEG_RD1_H_Zg_8TeV \
      ...
      --filein file:PYTHIA8_POWHEG_RD1_H_Zg_8TeV_cff_py_GEN_SIM.root \
      --no_exec')
elif int(step) == 2:
  os.system('cmsDriver.py STEP2_PYTHIA8_POWHEG_RD1_H_Zg_8TeV \
      ...
      --datatier AODSIM,DQM \
      --filein file:REDIGI_PYTHIA8_POWHEG_RD1_H_Zg_8TeV_DIGI_L1_DIGI2RAW_HLT_PU.root \
      --no_exec')
else:
