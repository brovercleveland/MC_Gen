...
if int(step) == 0:
  os.system('cmsDriver.py PYTHIA8_H_Zg_M{0}_Spin2_8TeV_cff.py \
      --step GEN,SIM \
      --conditions START53_V27::All \
      --pileup NoPileUp \
      --datamix NODATAMIXER \
  ...
  os.system('cmsDriver.py REDIGI_H_Zg_M{0}_Spin2 \
      ...
      --filein file:PYTHIA8_H_Zg_M{0}_Spin2_8TeV_cff_py_GEN_SIM.root \
      -n 10\
      --no_exec'.format(sys.argv[1]))
  moveFile()
elif int(step) == 2:
  os.system('cmsDriver.py STEP2_H_Zg_M{0}_Spin2 \
      ...
      --eventcontent AODSIM \
      --datatier AODSIM \
      --filein file:REDIGI_H_Zg_M{0}_Spin2_DIGI_L1_DIGI2RAW_HLT_PU.root \
      -n 10\
      --no_exec'.format(sys.argv[1]))
  moveFile()
