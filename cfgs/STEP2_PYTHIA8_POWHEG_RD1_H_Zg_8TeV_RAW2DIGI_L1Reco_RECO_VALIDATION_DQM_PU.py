...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:REDIGI_PYTHIA8_POWHEG_RD1_H_Zg_8TeV_DIGI_L1_DIGI2RAW_HLT_PU.root')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('STEP2_PYTHIA8_POWHEG_RD1_H_Zg_8TeV nevts:1'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('STEP2_PYTHIA8_POWHEG_RD1_H_Zg_8TeV_RAW2DIGI_L1Reco_RECO_VALIDATION_DQM_PU.root'),
