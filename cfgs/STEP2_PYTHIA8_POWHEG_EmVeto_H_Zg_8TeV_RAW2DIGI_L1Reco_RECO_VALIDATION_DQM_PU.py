...
# with command line options: STEP2_PYTHIA8_POWHEG_EmVeto_H_Zg_8TeV --step RAW2DIGI,L1Reco,RECO,VALIDATION:validation_prod,DQM:DQMOfflinePOGMC --conditions START53_V27::All --pileup 2012_Summer_50ns_PoissonOOTPU --pileup_input dbs:/RelValMinBias/CMSSW_5_2_1-START52_V4-v1/GEN-SIM --datamix NODATAMIXER --eventcontent AODSIM,DQM --datatier AODSIM,DQM --filein file:REDIGI_PYTHIA8_POWHEG_EmVeto_H_Zg_8TeV_DIGI_L1_DIGI2RAW_HLT_PU.root --no_exec
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:REDIGI_PYTHIA8_POWHEG_EmVeto_H_Zg_8TeV_DIGI_L1_DIGI2RAW_HLT_PU.root')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('STEP2_PYTHIA8_POWHEG_EmVeto_H_Zg_8TeV nevts:1'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('STEP2_PYTHIA8_POWHEG_EmVeto_H_Zg_8TeV_RAW2DIGI_L1Reco_RECO_VALIDATION_DQM_PU.root'),
